...
2. Морфить код, если вкратце, это самомодификация кода на лету (Это реализовано в данном проекте для x86).
...
Функции мутирования PE перед запуском. Это позволяет обойти детект в памяти.
...
4)Перед запуском происходит мутация PE, что позволяет обойти детект в памяти у некоторых антивирусов.
